...
var repositorySet = wire.NewSet(repository.NewDB, repository.NewRepository, repository.NewUserRepository, repository.NewTeamRepository, repository.NewUserTeamRoleRepository)
